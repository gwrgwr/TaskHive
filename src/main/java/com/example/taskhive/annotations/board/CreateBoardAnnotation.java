...
@Operation(summary = "Create board", description = "Create board to application", method = "POST")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Board Created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Board.class))),
...
public @interface CreateBoardAnnotation {
}
