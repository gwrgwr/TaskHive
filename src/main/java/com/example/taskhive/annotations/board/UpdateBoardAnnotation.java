...
@Operation(summary = "Update board", description = "Update board from application", method = "PUT")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Board Updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Board.class))),
...
public @interface UpdateBoardAnnotation {
}
