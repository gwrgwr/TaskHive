...
@Operation(summary = "Add Collaborator", description = "Add Collaborator to Board", method = "PUT")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Collaborator Added", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Board.class))),
...
public @interface AddCollaboratorBoardAnnotation {
}
