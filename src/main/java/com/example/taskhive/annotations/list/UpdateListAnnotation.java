...
@Operation(summary = "Update List", description = "Update List to application", method = "PUT")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "List Updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ListEntity.class))),
...
public @interface UpdateListAnnotation {
}
