...
@Operation(summary = "Change position", description = "Change position from List", method = "PUT")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Position Changed", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ListEntity.class))),
...
public @interface ChangeListPositionAnnotation {
}
