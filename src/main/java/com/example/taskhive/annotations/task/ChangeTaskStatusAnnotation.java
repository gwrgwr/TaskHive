...
@Operation(summary = "Update Status", description = "Update Status from Task", method = "PUT")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Status Updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Task.class))),
...
public @interface ChangeTaskStatusAnnotation {
}
