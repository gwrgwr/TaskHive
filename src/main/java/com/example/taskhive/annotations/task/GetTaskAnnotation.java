...
@Operation(summary = "Get Task", description = "Get Task from application", method = "GET")
@ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Got Task", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Task.class))),
...
public @interface GetTaskAnnotation {
}
