...
@Operation(summary = "Upload file", description = "Upload File to application", method = "POST")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "File Uploaded", content = @Content(mediaType = "application/json", schema = @Schema(implementation = FileDB.class))),
...
public @interface UploadFileAnnotation {
}
